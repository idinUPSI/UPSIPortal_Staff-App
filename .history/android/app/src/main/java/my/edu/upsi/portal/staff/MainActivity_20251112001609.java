        ...
        new android.os.Handler(android.os.Looper.getMainLooper()).postDelayed(() -> {
            try {
                if (getBridge() != null && getBridge().getWebView() != null) {
                    ...
                    // Inject CSS to add padding-top to body and html
                    String javascript = 
                        "(function() {" +
                        ...
                        "  console.log('Status bar padding injected: " + statusBarHeight + "px');" +
                        "})();";
                    
                    webView.evaluateJavascript(javascript, null);
                    
                    android.util.Log.i("MainActivity", "Injected status bar padding: " + statusBarHeight + "px");
                }
            } catch (Exception e) {
